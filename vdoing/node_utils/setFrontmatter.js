...
const { type, repairDate, dateFormat, uuid } = require('./modules/fn')
...
---`
      ...
      // 已有FrontMatter，但是没有id、title、date、permalink、categories、tags数据的
      if (!matterData.hasOwnProperty('id')) {
        // ID
        matterData.id = uuid(16, 16)
        mark = true
      }
